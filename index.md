# Vibe Coding Webinar: Example Apps

This page collects working examples of small web apps built with generative AI / vibe coding.

| App | Live demo | Source code | What it demonstrates |
|---|---|---|---|
| Gen Alpha Spaced Repetition Flashcard App | [Open app](https://gdsaxton.github.io/gen-alpha-slang/) | [View code](https://github.com/gdsaxton/gen-alpha-slang) | Simple static web app, user input, dictionary-style lookup |
| Retirement Planning Tool | [Open app](https://gdsaxton.github.io/retirement-planning-tool/) | [View code](https://github.com/gdsaxton/retirement-planning-tool) | Interactive retirement planning calculator |
